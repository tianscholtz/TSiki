  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved revision as @revision" do
        ...
        post :create, {:revision => { "title" => "invalid value" }}, valid_session
        assigns(:revision).should be_a_new(Revision)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested revision" do
        ...
        Revision.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => revision.to_param, :revision => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the revision as @revision" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Revision.any_instance.stub(:save).and_return(false)
        put :update, {:id => revision.to_param, :revision => { "title" => "invalid value" }}, valid_session
        assigns(:revision).should eq(revision)
      end
